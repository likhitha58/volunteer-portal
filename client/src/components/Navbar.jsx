...
const Navbar = () => {
  ...
  const handleLoginClick = () => {
    navigate("/admin"); // ✅ now this will work
  };
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav gap-3">
              ...
              <li className="nav-item">
                {/* ✅ change from <a> to <button> for proper routing */}
                <button className="nav-link btn btn-link text-white" onClick={handleLoginClick}>
                  Login
                </button>
              </li>
              <li className="nav-item">
      ...
      {showAbout && (
        <div className="about-glass-popup">
          <div className="about-container p-5 rounded-4">
            ...
            <p>
              <strong>Basti Ki Pathshala</strong> is a volunteer-led initiative that brings education, resources,
              and hope to children in underserved communities.
            </p>
            <p>
              Our mission is to ensure that every child—regardless of their socioeconomic background—has access to
              basic education, life skills, and opportunities to dream big.
            </p>
            <p>
              With the help of selfless volunteers and generous donors, we conduct daily learning sessions,
              workshops, and creative programs in slums and bastis.
            </p>
            <p>
